...
export default {
  ...
  setup() {
      ...
      await axios
        ...
        .then(function (response) {
          if (response.data.statuscode == 200) {
            //store data
            formData.first_name = response.data.data.user_details.first_name;
            formData.last_name = response.data.data.user_details.last_name;
            formData.email = response.data.data.user_details.email;
            formData.mobile = response.data.data.user_details.mobile;
          }
        });
    ...
    async function updateProfile() {
      const url = `${baseUrl}/user/update/profile/details`;
      formData.isLoadingButton = true;
      ...
      await axios
        ...
        .then(function (response) {
          if (response.data.statuscode == 200) {
            ...
            createToast("Profile details Updated successfully!.", {
              type: "success",
            });
            userProfile();

            resetForm();
            formData.isLoadingButton = false;
          }
...
.form_wrapper input[type="password"]:focus {
  -webkit-box-shadow: 0 0 2px 1px #3944f7;
  -moz-box-shadow: 0 0 2px 1px #3944f7;
  box-shadow: 0 0 2px 1px #3944f7;
