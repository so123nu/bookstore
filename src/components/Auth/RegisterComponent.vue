        ...
        <div class="">
          <form @submit.prevent="register">
            ...
            <input
              ...
              v-if="!isLoading"
            />
            <div id="spinner_container" v-if="isLoading">
              <img src="../../assets/images/spinner.jpg" alt="" id="spinner" />
            </div>
          </form>
        </div>
      </div>
      ...
      await axios
        ...
        .then(function (response) {
          if (response.data.statuscode == 200) {
            ...
            createToast(
              "Registration Successful.Please Verify Email Sent on your mail to Proceed.",
              { type: "success" }
            );
